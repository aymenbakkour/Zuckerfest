...
const TEMPLATES = [
  ...
  "يطيب لي بمناسبة حلول عيد الفطر السعيد أن أزف إليكم أخلص التهاني وأطيب التمنيات، سائلاً المولى عز وجل أن يعيده عليكم بالخير واليمن والبركات، وأن يجعل أيامكم كلها أفراحاً ومسرات. 🌙✨\n\nمع خالص التقدير،\n{name}",
  "فرحة العيد لا تكتمل إلا بوجودكم، وبهجته لا تحلو إلا بقربكم. كل عام وأنتم بخير بمناسبة عيد الفطر المبارك، أعاده الله علينا وعليكم بالصحة والعافية والسلام. 🎉🌺\n\nالمرسل:\n{name}",
  "تقبل الله طاعتكم، وأتم بالعيد فرحتكم، وأقر أعينكم بنصر أمتكم. عيد فطر مبارك لكم ولجميع أفراد أسرتكم الكريمة. 🕌🕊️\n\nمع أطيب التحيات،\n{name}",
  "أرسل لكم باقة من الورد والياسمين، معطرة بأصدق الدعوات بمناسبة عيد الفطر المبارك. كل عام وأنتم إلى الله أقرب، وعلى طاعته أدوم. 🌸✨\n\nمع خالص المودة:\n{name}",
  "بمناسبة عيد الفطر المبارك، أتقدم إليكم بأسمى آيات التهاني والتبريكات. نسأل الله أن يتقبل منا ومنكم صالح الأعمال وأن يرزقنا وإياكم السعادة في الدارين. 🌟🌙\n\nالمرسل:\n{name}",
  "عيدكم مبارك وعساكم من عواده! أسأل الله أن يغمر قلوبكم بالفرح والسعادة، وأن يجعل هذا العيد بداية لأيام جميلة مليئة بالخير والنجاح. 🎊🎈\n\nمع أطيب التمنيات:\n{name}",
  "كل عام وأنتم بخير بمناسبة عيد الفطر السعيد. أعاده الله عليكم وعلى من تحبون بالصحة والسلامة، وجعل كل أيامكم أعياداً تتزين بابتساماتكم. 🌺✨\n\nالمرسل:\n{name}",
  "مع قطرات الندى وما يحمله الورد من شذى، أرسل لكم أصدق التهاني بمناسبة العيد. تقبل الله أعمالكم وأسعد أيامكم. 🌹🕊️\n\nمع خالص التقدير،\n{name}",
  "سبقتنا إليكم الأمنيات، وتسبقها الفرحة والمسرات، لنهنئكم بحلول عيد الفطر المبارك. كل عام وأنتم بخير وصحة وعافية. 🎉🕌\n\nمع أطيب التحيات،\n{name}",
  "هنأكم الله بالقبول، وأسكنكم الجنة مع الرسول، ورزقكم بالعيد بهجة لا تزول. عيد فطر مبارك وكل عام وأنتم بخير. 🌙✨\n\nالمرسل:\n{name}"
];
