...
const TEMPLATES = [
  "بنسيم الرحمة وعبير المغفرة، أزف إليكم أصدق التهاني وأطيب الأماني بمناسبة حلول عيد الفطر المبارك. أسأل الله العلي القدير أن يتقبل منا ومنكم الصيام والقيام وصالح الأعمال، وأن يعيده علينا وعليكم باليمن والخير والبركات. 🌙✨\n\nكل عام وأنتم بخير،\nالمرسل: {name}",
  "تتلاقى الأرواح بالحب والود في هذا اليوم السعيد، ويسعدني أن أبعث لكم باقة من الأمنيات العطرة بمناسبة عيد الفطر المبارك. جعله الله عيد فرح وسرور، وجعل أيامكم كلها أعياداً تتلألأ بالسعادة والرضا. 🕌🌺\n\nمع أطيب التحيات،\n{name}",
  "بكل مشاعر الود والاحترام، أتقدم إليكم بأسمى آيات التهاني والتبريكات بمناسبة عيد الفطر السعيد. أعاده الله عليكم وعلى أحبابكم بالخير واليمن والبركات، وجعل أيامكم كلها سعادة وهناء. 🌟🎉\n\nمع خالص المودة،\n{name}",
  "عيد فطر مبارك! أرجو من الله أن يغمر أيامكم بالبهجة والسرور، وأن يتقبل طاعاتكم ويجعلكم من عتقائه. كل عام وأنتم إلى الله أقرب، وعلى طاعته أدوم. 🌙✨\n\nأطيب التمنيات،\n{name}",
  "مع إشراقة شمس عيد الفطر المبارك، أبعث إليكم أرق التهاني وأصدق الدعوات. أسأل الله أن يملأ قلوبكم بالسعادة، وبيوتكم بالبركة، وأن يعيد هذه الأيام المباركة عليكم بالخير واليمن والبركات. 🕊️🌸\n\nتهنئة من القلب،\n{name}",
  "تهنئة محملة بأريج الزهور وعطر العود بمناسبة عيد الفطر السعيد. تقبل الله منا ومنكم صالح الأعمال، وأدام عليكم نعمة الصحة والعافية والفرح. عساكم من عواده! 🌺🎉\n\nمع خالص التقدير،\n{name}",
  "بمناسبة حلول عيد الفطر المبارك، أتقدم إليكم بأخلص التهاني وأطيب التمنيات. جعله الله عيداً سعيداً عليكم وعلى أسرتكم الكريمة، وكل عام وأنتم بألف خير. 🕌✨\n\nأجمل التحيات،\n{name}",
  "فرحة العيد لا تكتمل إلا بوجودكم، وسعادته لا تحلو إلا بتهنئتكم. أسأل الله أن يتقبل طاعتكم وأن يجعل أيامكم كلها أعياداً. عيدكم مبارك وسعيد! 🌟🎈\n\nتحياتي،\n{name}",
  "أدام الله لكم الأعياد دهوراً، وألبسكم من تقواه نوراً. عيد فطر مبارك، تقبل الله طاعتكم وأتم بالعيد فرحتكم. كل عام وأنتم بخير! 🌙🕊️\n\nمع صادق الود،\n{name}",
  "يسعدني أن أبعث إليكم أصدق التهاني بمناسبة عيد الفطر المبارك. أعاده الله عليكم باليمن والبركات، وجعل أيامكم مليئة بالرضا والسعادة. عساكم من عواده! 🌸✨\n\nالمرسل:\n{name}"
];
...
export default function EidGreetingApp() {
  ...
  const messageWithLink = `${currentMessage}\n\nصمم تهنئتك الخاصة من هنا: https://zuckerfest.netlify.app/`;
  const whatsappUrl = `https://wa.me/?text=${encodeURIComponent(messageWithLink)}`;
